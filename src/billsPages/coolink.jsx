          ...
          <div className='md:w-[95%] w-full m-auto flex h-screen justify-between'>
            ...
            <div className='cursor-pointer md:m-auto md:block hidden my-4' onClick={()=>{back(-1)}}>
              <Icon icon="material-symbols:arrow-back-rounded" color="#333" width="30" />
                ...
                <p className='my-4 md:text-base text-[14px]'>Coolink</p>

                <div>
                <input style={{border:"2px solid  #C4C4C4"}} className="md:w-[100%] w-[95%] md:p-2 p-1 my-2"  type={"num"} placeholder="Enter user account Id " />
                ...
                <select style={{border:"2px solid  #C4C4C4"}}  placeholder='plan' className=' md:p-2 p-1 my-4 md:w-[100%]  w-[95%] rounded-lg'>
                            ...
                            <option  className=' md:text-sm text-[12px]'>1 month</option>
                            <option  className=' md:text-sm text-[12px]'>2 months</option>
                            <option  className=' md:text-sm text-[12px]'>3 Months</option>
                        </select>
