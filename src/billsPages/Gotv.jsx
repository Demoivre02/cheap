    ...
    <div>
        ...
        <div className='bg-[#F8F8F8] '>
          ...
          <div className='md:block hidden'> 
            ...
            <div className='md:w-[55%] w-full md:mx-auto bg-[#fff] rounded-lg p-4 mt-4'>
            ...
            <div className='cursor-pointer md:m-auto md:block hidden my-4' onClick={()=>{back(-1)}}>
              <Icon icon="material-symbols:arrow-back-rounded" color="#333" width="30" />
                ...
                <p className='my-4 md:text-base text-[14px]'>GOTV</p>

                <div>
                <input style={{border:"2px solid  #C4C4C4"}} className="md:w-[100%] w-[95%] md:p-2 p-1 my-2"  type={"num"} placeholder="Smart card number" />
                <input style={{border:"2px solid  #C4C4C4"}} className="md:w-[100%] w-[95%] md:p-2 p-1 my-2"  type={"num"} placeholder="Meter number" />
