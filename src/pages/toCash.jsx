            ...
            <div className='cursor-pointer md:m-auto md:block hidden my-4' onClick={()=>{back(-1)}}>
              <Icon icon="material-symbols:arrow-back-rounded" color="#333" width="30" />
                ...
                <div>
                      ...
                      <div>
                        <input style={{border:"2px solid  #C4C4C4"}} className="md:w-[100%] w-[95%] p-2 my-2"  type={"num"} placeholder="Phone number" />
                      </div>
                    ...
                    <div>
                        <input style={{border:"2px solid  #C4C4C4"}} className="md:w-[100%] w-[95%] p-2 my-2"  type={"num"} placeholder="Amount to recieve" />
                    </div>
