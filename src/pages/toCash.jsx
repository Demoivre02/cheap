        ...
        <div className='bg-[#F8F8F8] '>
          ...
          <div className='w-[95%] m-auto flex h-screen justify-between'>
            ...
            <div className='w-[55%] bg-[#fff] rounded-lg p-4 mt-4'>
                ...
                <p className='my-4'>Airtime to cash</p>
                ...
                <div>
                      ...
                      <div>
                        <input style={{border:"2px solid  #C4C4C4"}} className="w-[100%] p-2 my-2"  type={"num"} placeholder="Phone number" />
                      </div>
                    ...
                    <div>
                        <input style={{border:"2px solid  #C4C4C4"}} className="w-[100%] p-2 my-2"  type={"num"} placeholder="Amount to recieve" />
                    </div>
