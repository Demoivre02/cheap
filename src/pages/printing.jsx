          ...
          <div className='md:w-[95%] w-full m-auto flex h-screen justify-between'>
            ...
            <div className='cursor-pointer md:m-auto md:block hidden my-4' onClick={()=>{back(-1)}}>
              <Icon icon="material-symbols:arrow-back-rounded" color="#333" width="30" />
                ...
                <select style={{border:"2px solid  #C4C4C4"}}  placeholder='plan' className=' p-2 my-4 md:w-[100%] w-[95%] rounded-lg'>
                ...
                <div>
                    ...
                    <input style={{border:"2px solid  #C4C4C4"}} className="md:w-[100%] w-[95%] p-2 my-2 rounded-lg"  type={"num"} placeholder="Quantity (i.e 1,2, 50)" />
