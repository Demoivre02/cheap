...
function Signup() {
  return (
    <div className="bg-[#554E90] pb-4">
        ...
        <p className='md:text-xl text-[14px] text-[#fff] pt-16 mb-8 text-center m-auto md:w-[35%] w-[80%]'>Your search for cheap and reliable data ends here and now</p>
        ...
        <div className='lg:w-[55%]   md:w-[80%] w-[90%]  bg-[#fff] text-center m-auto rounded-[10px] shadow-lg'>
          ...
          <form className=''>
            <div className='md:mt-2 mt-0 border-black'>
              <input style={{border:"2px solid  #C4C4C4"}} className='  m-auto lg:w-[45%] md:w-[65%] w-[85%] p-3 text-xl rounded-lg mt-4 ' type={"text"} name="Fname" placeholder='First name'/>
            </div>
            <div className='md:mt-2 mt-0'>
              <input style={{border:"2px solid  #C4C4C4"}} className=' m-auto lg:w-[45%] md:w-[65%] w-[85%] p-3 text-xl rounded-lg mt-4 ' type={"text"} name="Lname" placeholder='Last name'/>
            </div>
            <div className='md:mt-2 mt-0'>
            ...
            <div className='md:mt-2 mt-0'>
              <input style={{border:"2px solid  #C4C4C4"}} className=' m-auto lg:w-[45%] md:w-[65%] w-[85%] p-3 text-xl rounded-lg mt-4 ' type={"text"} name="phone" placeholder=' Enter Phone number'/>
            </div>
            <div className='md:mt-2 mt-0'>
              <input style={{border:"2px solid  #C4C4C4"}} className=' m-auto lg:w-[45%] md:w-[65%] w-[85%] p-3 text-xl rounded-lg mt-4 ' type={"text"} name="password" placeholder='Enter Password'/>
            </div>
            <div className='md:mt-2 mt-0'>
            ...
            <Link to="/dashboard">
              <div className='md:p-3 p-2 bg-[#0E3F74] mt-4 hover:bg-transparent cursor-pointer hover:border-2 hover:text-[#0E3F74] text-[#fff] rounded-lg m-auto md:text-xl text-[12px] w-[45%]'>
                Create Account
              </div>
            </Link>


            <div className='p-3 bg-[#0E3F74] mt-8 bg-white cursor-pointer border-2 border-[#0E3F74]  hover:text-[#0E3F74] text-[#0E3F74] rounded-lg m-auto md:text-xl text-[12px] md:w-[45%] w-[80%]'>
